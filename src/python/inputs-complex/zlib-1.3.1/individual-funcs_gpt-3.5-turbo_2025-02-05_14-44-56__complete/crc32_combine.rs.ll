; ModuleID = './inputs-complex/zlib-1.3.1//individual-funcs_gpt-3.5-turbo_2025-02-05_14-44-56/crc32_combine.rs.bc'
...
@alloc8 = private unnamed_addr constant <{ [96 x i8] }> <{ [96 x i8] c"./inputs-complex/zlib-1.3.1//individual-funcs_gpt-3.5-turbo_2025-02-05_14-44-56/crc32_combine.rs" }>, align 1
@alloc9 = private unnamed_addr constant <{ i8*, [16 x i8] }> <{ i8* getelementptr inbounds (<{ [96 x i8] }>, <{ [96 x i8] }>* @alloc8, i32 0, i32 0, i32 0), [16 x i8] c"`\00\00\00\00\00\00\00\10\00\00\00\05\00\00\00" }>, align 8
...
^0 = module: (path: "./inputs-complex/zlib-1.3.1//individual-funcs_gpt-3.5-turbo_2025-02-05_14-44-56/crc32_combine.rs.bc", hash: (579354852, 3314471790, 42156789, 2299404909, 953625790))
