...
#[no_mangle]
#[no_mangle]
fn build_bl_tree(s: &mut deflate_state) -> c_int {
    let mut max_blindex: c_int;
    scan_tree(s, s.dyn_ltree as *mut ct_data, s.l_desc.max_code);
    scan_tree(s, s.dyn_dtree as *mut ct_data, s.d_desc.max_code);
