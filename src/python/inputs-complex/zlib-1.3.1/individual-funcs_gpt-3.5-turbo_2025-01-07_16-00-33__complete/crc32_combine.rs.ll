; ModuleID = './inputs-complex/zlib-1.3.1//individual-funcs_gpt-3.5-turbo_2025-01-07_16-00-33/crc32_combine.rs.bc'
...
@alloc8 = private unnamed_addr constant <{ [96 x i8] }> <{ [96 x i8] c"./inputs-complex/zlib-1.3.1//individual-funcs_gpt-3.5-turbo_2025-01-07_16-00-33/crc32_combine.rs" }>, align 1
@alloc9 = private unnamed_addr constant <{ i8*, [16 x i8] }> <{ i8* getelementptr inbounds (<{ [96 x i8] }>, <{ [96 x i8] }>* @alloc8, i32 0, i32 0, i32 0), [16 x i8] c"`\00\00\00\00\00\00\00\0C\00\00\00\05\00\00\00" }>, align 8
...
; Function Attrs: nonlazybind uwtable
define i64 @crc32_combine(i64 %crc1, i64 %crc2, i64 %len2) unnamed_addr #0 {
start:
  %0 = call i64 @crc32_combine64(i64 %crc1, i64 %crc2, i64 %len2)
  br label %bb1
...
^0 = module: (path: "./inputs-complex/zlib-1.3.1//individual-funcs_gpt-3.5-turbo_2025-01-07_16-00-33/crc32_combine.rs.bc", hash: (2083828419, 3189022913, 3693912108, 1648927866, 3533119760))
