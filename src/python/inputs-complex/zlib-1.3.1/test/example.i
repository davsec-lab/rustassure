...
static void test_deflate(Byte *compr, uLong comprLen) {
    ...
    err = deflateInit_((&c_stream), ((-1)), "1.3.1", (int)sizeof(z_stream));
...
static void test_inflate(Byte *compr, uLong comprLen, Byte *uncompr,
    ...
    err = inflateInit_((&d_stream), "1.3.1", (int)sizeof(z_stream));
...
static void test_dict_deflate(Byte *compr, uLong comprLen) {
    ...
    c_stream.zfree = zfree;
    c_stream.opaque = (voidpf)0;
    err = deflateInit_((&c_stream), (9), "1.3.1", (int)sizeof(z_stream));
    { if (err != 0) { fprintf(stderr, "%s error: %d\n", "deflateInit", err); exit(1); } };
...
int main(int argc, char *argv[]) {
    ...
    static const char* myVersion = "1.3.1";
    if (zlibVersion()[0] != myVersion[0]) {
        fprintf(stderr, "incompatible zlib version\n");
        exit(1);
    } else if (strcmp(zlibVersion(), "1.3.1") != 0) {
        fprintf(stderr, "warning: different zlib version linked: %s\n",
                zlibVersion());
    }
    printf("zlib version %s = 0x%04x, compile flags = 0x%lx\n",
            "1.3.1", 0x1310, zlibCompileFlags());
