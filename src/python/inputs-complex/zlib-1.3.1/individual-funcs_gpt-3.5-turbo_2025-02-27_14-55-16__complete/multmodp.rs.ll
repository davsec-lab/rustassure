; ModuleID = './inputs-complex/zlib-1.3.1/individual-funcs_gpt-3.5-turbo_2025-02-27_14-55-16/multmodp.rs.bc'
...
@alloc5 = private unnamed_addr constant <{ [90 x i8] }> <{ [90 x i8] c"./inputs-complex/zlib-1.3.1/individual-funcs_gpt-3.5-turbo_2025-02-27_14-55-16/multmodp.rs" }>, align 1
@alloc6 = private unnamed_addr constant <{ i8*, [16 x i8] }> <{ i8* getelementptr inbounds (<{ [90 x i8] }>, <{ [90 x i8] }>* @alloc5, i32 0, i32 0, i32 0), [16 x i8] c"Z\00\00\00\00\00\00\00\0D\00\00\00\14\00\00\00" }>, align 8
...
^0 = module: (path: "./inputs-complex/zlib-1.3.1/individual-funcs_gpt-3.5-turbo_2025-02-27_14-55-16/multmodp.rs.bc", hash: (2514072359, 2170619649, 282712034, 2263809350, 3474133332))
