; ModuleID = './inputs-complex/zlib-1.3.1/individual-funcs_gpt-3.5-turbo_2025-02-27_14-55-16/gzclose.i.bc'
source_filename = "./inputs-complex/zlib-1.3.1/individual-funcs_gpt-3.5-turbo_2025-02-27_14-55-16/gzclose.i"
...
define dso_local i32 @gzclose(%struct.gzFile_s* noundef %0) #0 {
...
declare dso_local i32 @gzclose_r(%struct.gzFile_s* noundef) #1

declare dso_local i32 @gzclose_w(%struct.gzFile_s* noundef) #1
