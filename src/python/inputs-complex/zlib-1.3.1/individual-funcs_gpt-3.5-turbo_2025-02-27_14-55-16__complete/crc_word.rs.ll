; ModuleID = './inputs-complex/zlib-1.3.1/individual-funcs_gpt-3.5-turbo_2025-02-27_14-55-16/crc_word.rs.bc'
...
@alloc26 = private unnamed_addr constant <{ [90 x i8] }> <{ [90 x i8] c"./inputs-complex/zlib-1.3.1/individual-funcs_gpt-3.5-turbo_2025-02-27_14-55-16/crc_word.rs" }>, align 1
@alloc27 = private unnamed_addr constant <{ i8*, [16 x i8] }> <{ i8* getelementptr inbounds (<{ [90 x i8] }>, <{ [90 x i8] }>* @alloc26, i32 0, i32 0, i32 0), [16 x i8] c"Z\00\00\00\00\00\00\00/\00\00\00\1E\00\00\00" }>, align 8
...
^0 = module: (path: "./inputs-complex/zlib-1.3.1/individual-funcs_gpt-3.5-turbo_2025-02-27_14-55-16/crc_word.rs.bc", hash: (2827313821, 1682004465, 1584396315, 4188396443, 4255758352))
