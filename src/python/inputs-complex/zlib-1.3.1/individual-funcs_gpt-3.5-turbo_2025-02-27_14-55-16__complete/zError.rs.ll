; ModuleID = './inputs-complex/zlib-1.3.1/individual-funcs_gpt-3.5-turbo_2025-02-27_14-55-16/zError.rs.bc'
...
@alloc20 = private unnamed_addr constant <{ [88 x i8] }> <{ [88 x i8] c"./inputs-complex/zlib-1.3.1/individual-funcs_gpt-3.5-turbo_2025-02-27_14-55-16/zError.rs" }>, align 1
@alloc21 = private unnamed_addr constant <{ i8*, [16 x i8] }> <{ i8* getelementptr inbounds (<{ [88 x i8] }>, <{ [88 x i8] }>* @alloc20, i32 0, i32 0, i32 0), [16 x i8] c"X\00\00\00\00\00\00\00\12\00\00\00\12\00\00\00" }>, align 8
...
^0 = module: (path: "./inputs-complex/zlib-1.3.1/individual-funcs_gpt-3.5-turbo_2025-02-27_14-55-16/zError.rs.bc", hash: (4275992728, 2815007479, 120341931, 2540227004, 258751402))
