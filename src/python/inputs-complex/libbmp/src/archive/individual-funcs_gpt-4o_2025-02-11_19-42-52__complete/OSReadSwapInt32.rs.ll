; ModuleID = 'inputs-complex/libbmp/src/individual-funcs_gpt-4o_2025-02-11_19-42-52/OSReadSwapInt32.rs.bc'
...
; Function Attrs: inlinehint uwtable
define { i8*, i64* } @_ZN4core3fmt10ArgumentV113new_lower_hex17h7d91d554374e7caaE(i32* align 4 %x) unnamed_addr #0 {
start:
  %0 = call { i8*, i64* } @_ZN4core3fmt10ArgumentV13new17hd5a56b2ed36f0757E(i32* align 4 %x, i1 (i32*, %"core::fmt::Formatter"*)* @"_ZN4core3fmt3num53_$LT$impl$u20$core..fmt..LowerHex$u20$for$u20$u32$GT$3fmt17h8b71fe7c98b89f5dE")
...
; Function Attrs: inlinehint uwtable
define i32 @_ZN4core3ptr14read_unaligned17he275989d8d8b89f4E(i32* %src) unnamed_addr #0 {
start:
...
bb1:                                              ; preds = %start
  %ptr = bitcast i8* %3 to i32*
  %val = call i32 @_ZN4core3ptr14read_unaligned17he275989d8d8b89f4E(i32* %ptr)
  br label %bb2

bb2:                                              ; preds = %bb1
  %4 = call i32 @llvm.bswap.i32(i32 %val)
...
bb2:                                              ; preds = %bb1
  %5 = call { i8*, i64* } @_ZN4core3fmt10ArgumentV113new_lower_hex17h7d91d554374e7caaE(i32* align 4 %result)
...
^0 = module: (path: "inputs-complex/libbmp/src/individual-funcs_gpt-4o_2025-02-11_19-42-52/OSReadSwapInt32.rs.bc", hash: (1902478979, 314590911, 1067676254, 267542775, 2609242808))
^1 = gv: (name: "llvm.memcpy.p0i8.p0i8.i64") ; guid = 614884070845456474
^2 = gv: (name: "_ZN4core3fmt10ArgumentV113new_lower_hex17h7d91d554374e7caaE", summaries: (function: (module: ^0, flags: (linkage: external, visibility: default, notEligibleToImport: 0, live: 0, dsoLocal: 0, canAutoHide: 0), insts: 7, calls: ((callee: ^3)), refs: (^10)))) ; guid = 1188552747184991273
^3 = gv: (name: "_ZN4core3fmt10ArgumentV13new17hd5a56b2ed36f0757E", summaries: (function: (module: ^0, flags: (linkage: external, visibility: default, notEligibleToImport: 0, live: 0, dsoLocal: 0, canAutoHide: 0), insts: 23))) ; guid = 1802585484436255194
^4 = gv: (name: "llvm.bswap.i32") ; guid = 2706216642482500884
^5 = gv: (name: "_ZN4core10intrinsics19copy_nonoverlapping17hf72796fc68d427f2E", summaries: (function: (module: ^0, flags: (linkage: external, visibility: default, notEligibleToImport: 0, live: 0, dsoLocal: 0, canAutoHide: 0), insts: 4))) ; guid = 2761347412020605678
^6 = gv: (name: "alloc5", summaries: (variable: (module: ^0, flags: (linkage: private, visibility: default, notEligibleToImport: 0, live: 0, dsoLocal: 1, canAutoHide: 0), varFlags: (readonly: 1, writeonly: 0, constant: 1)))) ; guid = 3138640408727556781
^7 = gv: (name: "os_read_swap_int32", summaries: (function: (module: ^0, flags: (linkage: external, visibility: default, notEligibleToImport: 0, live: 0, dsoLocal: 0, canAutoHide: 0), insts: 14, calls: ((callee: ^13))))) ; guid = 3735994594931237016
^8 = gv: (name: "alloc7", summaries: (variable: (module: ^0, flags: (linkage: private, visibility: default, notEligibleToImport: 0, live: 0, dsoLocal: 1, canAutoHide: 0), varFlags: (readonly: 1, writeonly: 0, constant: 1)))) ; guid = 6531098798428537960
...
^10 = gv: (name: "_ZN4core3fmt3num53_$LT$impl$u20$core..fmt..LowerHex$u20$for$u20$u32$GT$3fmt17h8b71fe7c98b89f5dE") ; guid = 9824452099063887761
^11 = gv: (name: "alloc16", summaries: (variable: (module: ^0, flags: (linkage: private, visibility: default, notEligibleToImport: 0, live: 0, dsoLocal: 1, canAutoHide: 0), varFlags: (readonly: 1, writeonly: 0, constant: 1)))) ; guid = 14539596038284925891
^12 = gv: (name: "alloc17", summaries: (variable: (module: ^0, flags: (linkage: private, visibility: default, notEligibleToImport: 0, live: 0, dsoLocal: 1, canAutoHide: 0), varFlags: (readonly: 1, writeonly: 0, constant: 1), refs: (^11)))) ; guid = 14741225294446286824
^13 = gv: (name: "_ZN4core3ptr14read_unaligned17he275989d8d8b89f4E", summaries: (function: (module: ^0, flags: (linkage: external, visibility: default, notEligibleToImport: 0, live: 0, dsoLocal: 0, canAutoHide: 0), insts: 15, calls: ((callee: ^5))))) ; guid = 14826084202071242589
^14 = gv: (name: "_ZN4core3fmt9Arguments16new_v1_formatted17hdeac272faaa71bd0E", summaries: (function: (module: ^0, flags: (linkage: internal, visibility: default, notEligibleToImport: 0, live: 0, dsoLocal: 1, canAutoHide: 0), insts: 26))) ; guid = 15797309256717015337
^15 = gv: (name: "main", summaries: (function: (module: ^0, flags: (linkage: external, visibility: default, notEligibleToImport: 0, live: 0, dsoLocal: 0, canAutoHide: 0), insts: 34, calls: ((callee: ^17), (callee: ^7), (callee: ^2), (callee: ^14), (callee: ^18)), refs: (^9, ^16)))) ; guid = 15822663052811949562
^16 = gv: (name: "alloc6", summaries: (variable: (module: ^0, flags: (linkage: private, visibility: default, notEligibleToImport: 0, live: 0, dsoLocal: 1, canAutoHide: 0), varFlags: (readonly: 1, writeonly: 0, constant: 1), refs: (^6, ^8)))) ; guid = 15829600909227849921
^17 = gv: (name: "_ZN4core5slice29_$LT$impl$u20$$u5b$T$u5d$$GT$6as_ptr17hafc9828d9407e790E", summaries: (function: (module: ^0, flags: (linkage: external, visibility: default, notEligibleToImport: 0, live: 0, dsoLocal: 0, canAutoHide: 0), insts: 2))) ; guid = 15980384162834336855
