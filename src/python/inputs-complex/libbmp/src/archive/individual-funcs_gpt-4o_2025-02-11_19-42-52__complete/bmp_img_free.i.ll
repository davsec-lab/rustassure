; ModuleID = 'inputs-complex/libbmp/src/individual-funcs_gpt-4o_2025-02-11_19-42-52/bmp_img_free.i.bc'
source_filename = "inputs-complex/libbmp/src/individual-funcs_gpt-4o_2025-02-11_19-42-52/bmp_img_free.i"
...
define void @bmp_img_free(%struct._bmp_img* noundef %img) #0 {
entry:
...
for.body:                                         ; preds = %for.cond
  ...
  %5 = load %struct._bmp_pixel**, %struct._bmp_pixel*** %img_pixels, align 8
  %6 = load i64, i64* %y, align 8
  %arrayidx = getelementptr inbounds %struct._bmp_pixel*, %struct._bmp_pixel** %5, i64 %6
  %7 = load %struct._bmp_pixel*, %struct._bmp_pixel** %arrayidx, align 8
  %8 = bitcast %struct._bmp_pixel* %7 to i8*
...
for.end:                                          ; preds = %for.cond
  ...
  %img_pixels2 = getelementptr inbounds %struct._bmp_img, %struct._bmp_img* %10, i32 0, i32 1
  %11 = load %struct._bmp_pixel**, %struct._bmp_pixel*** %img_pixels2, align 8
  %12 = bitcast %struct._bmp_pixel** %11 to i8*
