; ModuleID = 'inputs-complex/libzahl/src/individual-funcs_gpt-3.5-turbo_2025-02-04_16-19-41/zzero1.i.bc'
source_filename = "inputs-complex/libzahl/src/individual-funcs_gpt-3.5-turbo_2025-02-04_16-19-41/zzero1.i"
...
define i32 @zzero1(%struct.zahl* noundef %a, %struct.zahl* noundef %b) #0 {
entry:
...
lor.rhs:                                          ; preds = %entry
  ...
  %call1 = call i32 @zzero(%struct.zahl* noundef %1)
