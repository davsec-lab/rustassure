; ModuleID = 'inputs-complex/mbedtls/library/individual-funcs_gpt-4o_2024-09-25_11-18-42__complete/ssl_generate_random.i.bc'
source_filename = "inputs-complex/mbedtls/library/individual-funcs_gpt-4o_2024-09-25_11-18-42__complete/ssl_generate_random.i"
...
@.str.1 = private unnamed_addr constant [32 x i8] c"client hello, current time: %lu\00", align 1

; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @ssl_generate_random(%struct.mbedtls_ssl_context* noundef %0) #0 {
  ...
  %10 = getelementptr inbounds %struct.mbedtls_ssl_handshake_params, %struct.mbedtls_ssl_handshake_params* %9, i32 0, i32 35
...
21:                                               ; preds = %1
  ...
  %25 = getelementptr inbounds %struct.mbedtls_ssl_handshake_params, %struct.mbedtls_ssl_handshake_params* %24, i32 0, i32 13
...
29:                                               ; preds = %21, %1
  %30 = call i64 @time(i64* noundef null) #3
  ...
  call void (%struct.mbedtls_ssl_context*, i32, i8*, i32, i8*, ...) @mbedtls_debug_print_msg(%struct.mbedtls_ssl_context* noundef %50, i32 noundef 3, i8* noundef getelementptr inbounds ([10 x i8], [10 x i8]* @.str, i64 0, i64 0), i32 noundef 788, i8* noundef getelementptr inbounds ([32 x i8], [32 x i8]* @.str.1, i64 0, i64 0), i64 noundef %51)
  %52 = load %struct.mbedtls_ssl_context*, %struct.mbedtls_ssl_context** %3, align 8
  %53 = getelementptr inbounds %struct.mbedtls_ssl_context, %struct.mbedtls_ssl_context* %52, i32 0, i32 0
  %54 = load %struct.mbedtls_ssl_config*, %struct.mbedtls_ssl_config** %53, align 8
  %55 = getelementptr inbounds %struct.mbedtls_ssl_config, %struct.mbedtls_ssl_config* %54, i32 0, i32 3
  %56 = load i32 (i8*, i8*, i64)*, i32 (i8*, i8*, i64)** %55, align 8
  ...
  %60 = getelementptr inbounds %struct.mbedtls_ssl_config, %struct.mbedtls_ssl_config* %59, i32 0, i32 4
  %61 = load i8*, i8** %60, align 8
  %62 = load i8*, i8** %5, align 8
  %63 = call i32 %56(i8* noundef %61, i8* noundef %62, i64 noundef 28)
