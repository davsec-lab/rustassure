; ModuleID = 'inputs-complex/mbedtls/library/individual-funcs_gpt-4o_2024-09-25_11-18-42__complete/mbedtls_cipher_get_name.i.bc'
source_filename = "inputs-complex/mbedtls/library/individual-funcs_gpt-4o_2024-09-25_11-18-42__complete/mbedtls_cipher_get_name.i"
...
define dso_local i8* @mbedtls_cipher_get_name(%struct.mbedtls_cipher_context_t* noundef %0) #0 {
  %2 = alloca i8*, align 8
...
11:                                               ; preds = %5
  ...
  %15 = getelementptr inbounds %struct.mbedtls_cipher_info_t, %struct.mbedtls_cipher_info_t* %14, i32 0, i32 3
