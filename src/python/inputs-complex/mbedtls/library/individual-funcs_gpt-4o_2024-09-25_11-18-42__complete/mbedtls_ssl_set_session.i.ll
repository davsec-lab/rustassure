; ModuleID = 'inputs-complex/mbedtls/library/individual-funcs_gpt-4o_2024-09-25_11-18-42__complete/mbedtls_ssl_set_session.i.bc'
source_filename = "inputs-complex/mbedtls/library/individual-funcs_gpt-4o_2024-09-25_11-18-42__complete/mbedtls_ssl_set_session.i"
...
define dso_local i32 @mbedtls_ssl_set_session(%struct.mbedtls_ssl_context* noundef %0, %struct.mbedtls_ssl_session* noundef %1) #0 {
  ...
  %8 = icmp eq %struct.mbedtls_ssl_context* %7, null
  br i1 %8, label %26, label %9

9:                                                ; preds = %2
  %10 = load %struct.mbedtls_ssl_session*, %struct.mbedtls_ssl_session** %5, align 8
  %11 = icmp eq %struct.mbedtls_ssl_session* %10, null
...
12:                                               ; preds = %9
  ...
  %16 = icmp eq %struct.mbedtls_ssl_session* %15, null
...
17:                                               ; preds = %12
  ...
  %21 = getelementptr inbounds %struct.mbedtls_ssl_config, %struct.mbedtls_ssl_config* %20, i32 0, i32 47
...
27:                                               ; preds = %17
  ...
  %29 = getelementptr inbounds %struct.mbedtls_ssl_context, %struct.mbedtls_ssl_context* %28, i32 0, i32 16
  %30 = load %struct.mbedtls_ssl_session*, %struct.mbedtls_ssl_session** %29, align 8
  %31 = load %struct.mbedtls_ssl_session*, %struct.mbedtls_ssl_session** %5, align 8
  %32 = call i32 @mbedtls_ssl_session_copy(%struct.mbedtls_ssl_session* noundef %30, %struct.mbedtls_ssl_session* noundef %31)
...
36:                                               ; preds = %27
  ...
  %40 = getelementptr inbounds %struct.mbedtls_ssl_handshake_params, %struct.mbedtls_ssl_handshake_params* %39, i32 0, i32 37
...
declare dso_local i32 @mbedtls_ssl_session_copy(%struct.mbedtls_ssl_session* noundef, %struct.mbedtls_ssl_session* noundef) #1
