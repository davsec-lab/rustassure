; ModuleID = 'inputs-complex/mbedtls/library/individual-funcs_gpt-4o_2024-09-25_11-18-42__complete/ssl_calc_finished_tls_sha256.i.bc'
source_filename = "inputs-complex/mbedtls/library/individual-funcs_gpt-4o_2024-09-25_11-18-42__complete/ssl_calc_finished_tls_sha256.i"
...
@.str.3 = private unnamed_addr constant [29 x i8] c"=> calc  finished tls sha256\00", align 1
@.str.4 = private unnamed_addr constant [20 x i8] c"finished sha2 state\00", align 1
...
define dso_local void @ssl_calc_finished_tls_sha256(%struct.mbedtls_ssl_context* noundef %0, i8* noundef %1, i32 noundef %2) #0 {
...
21:                                               ; preds = %17, %3
  ...
  call void @mbedtls_sha256_init(%struct.mbedtls_sha256_context* noundef %10)
  %26 = load %struct.mbedtls_ssl_context*, %struct.mbedtls_ssl_context** %4, align 8
  call void (%struct.mbedtls_ssl_context*, i32, i8*, i32, i8*, ...) @mbedtls_debug_print_msg(%struct.mbedtls_ssl_context* noundef %26, i32 noundef 2, i8* noundef getelementptr inbounds ([10 x i8], [10 x i8]* @.str.2, i64 0, i64 0), i32 noundef 3170, i8* noundef getelementptr inbounds ([29 x i8], [29 x i8]* @.str.3, i64 0, i64 0))
  ...
  %30 = getelementptr inbounds %struct.mbedtls_ssl_handshake_params, %struct.mbedtls_ssl_handshake_params* %29, i32 0, i32 27
  call void @mbedtls_sha256_clone(%struct.mbedtls_sha256_context* noundef %10, %struct.mbedtls_sha256_context* noundef %30)
  %31 = load %struct.mbedtls_ssl_context*, %struct.mbedtls_ssl_context** %4, align 8
  %32 = getelementptr inbounds %struct.mbedtls_sha256_context, %struct.mbedtls_sha256_context* %10, i32 0, i32 1
  %33 = getelementptr inbounds [8 x i32], [8 x i32]* %32, i64 0, i64 0
  %34 = bitcast i32* %33 to i8*
  call void @mbedtls_debug_print_buf(%struct.mbedtls_ssl_context* noundef %31, i32 noundef 4, i8* noundef getelementptr inbounds ([10 x i8], [10 x i8]* @.str.2, i64 0, i64 0), i32 noundef 3182, i8* noundef getelementptr inbounds ([20 x i8], [20 x i8]* @.str.4, i64 0, i64 0), i8* noundef %34, i64 noundef 32)
  %35 = getelementptr inbounds [32 x i8], [32 x i8]* %9, i64 0, i64 0
  %36 = call i32 @mbedtls_sha256_finish_ret(%struct.mbedtls_sha256_context* noundef %10, i8* noundef %35)
  call void @mbedtls_sha256_free(%struct.mbedtls_sha256_context* noundef %10)
  ...
  %50 = call i32 %41(i8* noundef %44, i64 noundef 48, i8* noundef %45, i8* noundef %46, i64 noundef 32, i8* noundef %47, i64 noundef %49)
  %51 = load %struct.mbedtls_ssl_context*, %struct.mbedtls_ssl_context** %4, align 8
  %52 = load i8*, i8** %5, align 8
  %53 = load i32, i32* %7, align 4
  %54 = sext i32 %53 to i64
  call void @mbedtls_debug_print_buf(%struct.mbedtls_ssl_context* noundef %51, i32 noundef 3, i8* noundef getelementptr inbounds ([10 x i8], [10 x i8]* @.str.2, i64 0, i64 0), i32 noundef 3192, i8* noundef getelementptr inbounds ([21 x i8], [21 x i8]* @.str.5, i64 0, i64 0), i8* noundef %52, i64 noundef %54)
  %55 = getelementptr inbounds [32 x i8], [32 x i8]* %9, i64 0, i64 0
  call void @mbedtls_platform_zeroize(i8* noundef %55, i64 noundef 32)
  %56 = load %struct.mbedtls_ssl_context*, %struct.mbedtls_ssl_context** %4, align 8
  call void (%struct.mbedtls_ssl_context*, i32, i8*, i32, i8*, ...) @mbedtls_debug_print_msg(%struct.mbedtls_ssl_context* noundef %56, i32 noundef 2, i8* noundef getelementptr inbounds ([10 x i8], [10 x i8]* @.str.2, i64 0, i64 0), i32 noundef 3196, i8* noundef getelementptr inbounds ([18 x i8], [18 x i8]* @.str.6, i64 0, i64 0))
  ret void
}
...
declare dso_local i32 @mbedtls_sha256_finish_ret(%struct.mbedtls_sha256_context* noundef, i8* noundef) #1
