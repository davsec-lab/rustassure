; ModuleID = 'inputs-complex/mbedtls/library/individual-funcs_gpt-4o_2024-09-25_11-18-42__complete/mbedtls_pk_rsa.i.bc'
source_filename = "inputs-complex/mbedtls/library/individual-funcs_gpt-4o_2024-09-25_11-18-42__complete/mbedtls_pk_rsa.i"
...
define dso_local %struct.mbedtls_rsa_context* @mbedtls_pk_rsa(%struct.mbedtls_pk_info_t* %0, i8* %1) #0 {
  ...
  %9 = bitcast i8* %8 to %struct.mbedtls_rsa_context*
  ret %struct.mbedtls_rsa_context* %9
}
