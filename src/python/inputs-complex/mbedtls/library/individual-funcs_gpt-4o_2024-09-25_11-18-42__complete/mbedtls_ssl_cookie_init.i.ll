; ModuleID = 'inputs-complex/mbedtls/library/individual-funcs_gpt-4o_2024-09-25_11-18-42__complete/mbedtls_ssl_cookie_init.i.bc'
source_filename = "inputs-complex/mbedtls/library/individual-funcs_gpt-4o_2024-09-25_11-18-42__complete/mbedtls_ssl_cookie_init.i"
...
define dso_local void @mbedtls_ssl_cookie_init(%struct.mbedtls_ssl_cookie_ctx* noundef %0) #0 {
  ...
  call void @mbedtls_md_init(%struct.mbedtls_md_context_t* noundef %4)
  %5 = load %struct.mbedtls_ssl_cookie_ctx*, %struct.mbedtls_ssl_cookie_ctx** %2, align 8
  %6 = getelementptr inbounds %struct.mbedtls_ssl_cookie_ctx, %struct.mbedtls_ssl_cookie_ctx* %5, i32 0, i32 1
