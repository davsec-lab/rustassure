; ModuleID = 'inputs-complex/mbedtls/library/individual-funcs_gpt-4o_2024-09-25_11-18-42__complete/mbedtls_net_free.i.bc'
source_filename = "inputs-complex/mbedtls/library/individual-funcs_gpt-4o_2024-09-25_11-18-42__complete/mbedtls_net_free.i"
...
define dso_local void @mbedtls_net_free(%struct.mbedtls_net_context* noundef %0) #0 {
...
8:                                                ; preds = %1
  ...
  %12 = call i32 @shutdown(i32 noundef %11, i32 noundef 2) #3
  ...
  %17 = load %struct.mbedtls_net_context*, %struct.mbedtls_net_context** %2, align 8
