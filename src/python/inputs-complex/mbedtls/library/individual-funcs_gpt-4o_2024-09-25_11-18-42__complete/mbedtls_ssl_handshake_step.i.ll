; ModuleID = 'inputs-complex/mbedtls/library/individual-funcs_gpt-4o_2024-09-25_11-18-42__complete/mbedtls_ssl_handshake_step.i.bc'
source_filename = "inputs-complex/mbedtls/library/individual-funcs_gpt-4o_2024-09-25_11-18-42__complete/mbedtls_ssl_handshake_step.i"
...
define dso_local i32 @mbedtls_ssl_handshake_step(%struct.mbedtls_ssl_context* noundef %0) #0 {
...
7:                                                ; preds = %1
  ...
  %11 = icmp eq %struct.mbedtls_ssl_config* %10, null
...
13:                                               ; preds = %7
  ...
  %17 = getelementptr inbounds %struct.mbedtls_ssl_config, %struct.mbedtls_ssl_config* %16, i32 0, i32 47
...
22:                                               ; preds = %13
  ...
  %24 = call i32 @mbedtls_ssl_handshake_client_step(%struct.mbedtls_ssl_context* noundef %23)
...
34:                                               ; preds = %25
  ...
  %36 = call i32 @mbedtls_ssl_handshake_server_step(%struct.mbedtls_ssl_context* noundef %35)
...
declare dso_local i32 @mbedtls_ssl_handshake_client_step(%struct.mbedtls_ssl_context* noundef) #1

declare dso_local i32 @mbedtls_ssl_handshake_server_step(%struct.mbedtls_ssl_context* noundef) #1
