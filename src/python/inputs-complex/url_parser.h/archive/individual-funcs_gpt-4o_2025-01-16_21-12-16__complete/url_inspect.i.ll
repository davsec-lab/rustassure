; ModuleID = 'inputs-complex/url.h/individual-funcs_gpt-4o_2025-01-16_21-12-16/url_inspect.i.bc'
source_filename = "inputs-complex/url.h/individual-funcs_gpt-4o_2025-01-16_21-12-16/url_inspect.i"
...
define void @url_inspect(i8* noundef %url) #0 {
entry:
  ...
  call void @url_data_inspect(%struct.url_data* noundef %call)
  ret void
}

declare void @url_data_inspect(%struct.url_data* noundef) #1
