; ModuleID = 'inputs-complex/url.h/individual-funcs_gpt-4o_2025-01-16_21-12-16/_OSSwapInt16.rs.bc'
...
define { i8*, i64* } @_ZN4core3fmt10ArgumentV113new_upper_hex17h6193519232ab1035E(i16* align 2 %x) unnamed_addr #0 {
start:
  %0 = call { i8*, i64* } @_ZN4core3fmt10ArgumentV13new17h0ffcd2089cf336f8E(i16* align 2 %x, i1 (i16*, %"core::fmt::Formatter"*)* @"_ZN4core3fmt3num53_$LT$impl$u20$core..fmt..UpperHex$u20$for$u20$u16$GT$3fmt17h5d1e259228031bdbE")
...
bb1:                                              ; preds = %start
  %1 = call { i8*, i64* } @_ZN4core3fmt10ArgumentV113new_upper_hex17h6193519232ab1035E(i16* align 2 %data)
  %_13.0 = extractvalue { i8*, i64* } %1, 0
  %_13.1 = extractvalue { i8*, i64* } %1, 1
  br label %bb2

bb2:                                              ; preds = %bb1
  %2 = call { i8*, i64* } @_ZN4core3fmt10ArgumentV113new_upper_hex17h6193519232ab1035E(i16* align 2 %swapped)
...
^0 = module: (path: "inputs-complex/url.h/individual-funcs_gpt-4o_2025-01-16_21-12-16/_OSSwapInt16.rs.bc", hash: (1380171358, 3695837236, 1799362187, 2108737523, 2300865275))
...
^5 = gv: (name: "alloc7", summaries: (variable: (module: ^0, flags: (linkage: private, visibility: default, notEligibleToImport: 0, live: 0, dsoLocal: 1, canAutoHide: 0), varFlags: (readonly: 1, writeonly: 0, constant: 1)))) ; guid = 8185127055082978339
^6 = gv: (name: "_ZN4core3fmt3num53_$LT$impl$u20$core..fmt..UpperHex$u20$for$u20$u16$GT$3fmt17h5d1e259228031bdbE") ; guid = 9430837551478272673
^7 = gv: (name: "_ZN4core3fmt10ArgumentV113new_upper_hex17h6193519232ab1035E", summaries: (function: (module: ^0, flags: (linkage: external, visibility: default, notEligibleToImport: 0, live: 0, dsoLocal: 0, canAutoHide: 0), insts: 7, calls: ((callee: ^11)), refs: (^6)))) ; guid = 14046477825166912086
...
^9 = gv: (name: "alloc6", summaries: (variable: (module: ^0, flags: (linkage: private, visibility: default, notEligibleToImport: 0, live: 0, dsoLocal: 1, canAutoHide: 0), varFlags: (readonly: 1, writeonly: 0, constant: 1), refs: (^3, ^5, ^4)))) ; guid = 15884416462654103392
