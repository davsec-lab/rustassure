; ModuleID = 'inputs-complex/url.h/individual-funcs_gpt-4o_2025-01-16_21-12-16/_OSSwapInt32.rs.bc'
...
start:
  ...
  store i32 305419896, i32* %original, align 4
  %_3 = load i32, i32* %original, align 4
  %0 = call i32 @osswap_int32(i32 %_3)
  store i32 %0, i32* %swapped, align 4
  br label %bb1

bb1:                                              ; preds = %start
  %1 = call { i8*, i64* } @_ZN4core3fmt10ArgumentV113new_upper_hex17hffe69cc4f5071599E(i32* align 4 %original)
  %_13.0 = extractvalue { i8*, i64* } %1, 0
  %_13.1 = extractvalue { i8*, i64* } %1, 1
  br label %bb2

bb2:                                              ; preds = %bb1
  %2 = call { i8*, i64* } @_ZN4core3fmt10ArgumentV113new_upper_hex17hffe69cc4f5071599E(i32* align 4 %swapped)
...
^0 = module: (path: "inputs-complex/url.h/individual-funcs_gpt-4o_2025-01-16_21-12-16/_OSSwapInt32.rs.bc", hash: (1275410598, 4234089085, 2824105367, 2762931776, 2556494985))
