; ModuleID = 'inputs-complex/url.h/individual-funcs_gpt-4o_2025-01-16_21-12-16/url_get_userinfo.i.bc'
source_filename = "inputs-complex/url.h/individual-funcs_gpt-4o_2025-01-16_21-12-16/url_get_userinfo.i"
...
define i8* @url_get_userinfo(i8* noundef %url) #0 {
entry:
...
land.lhs.true:                                    ; preds = %do.body
  ...
  %userinfo = getelementptr inbounds %struct.url_data, %struct.url_data* %2, i32 0, i32 2
  %3 = load i8*, i8** %userinfo, align 8
  %tobool1 = icmp ne i8* %3, null
  br i1 %tobool1, label %cond.true, label %cond.false

cond.true:                                        ; preds = %land.lhs.true
  %4 = load %struct.url_data*, %struct.url_data** %data, align 8
  %userinfo2 = getelementptr inbounds %struct.url_data, %struct.url_data* %4, i32 0, i32 2
  %5 = load i8*, i8** %userinfo2, align 8
