; ModuleID = 'inputs-complex/url.h/individual-funcs_gpt-4o_2025-01-16_21-12-16/OSWriteSwapInt32.rs.bc'
...
bb2:                                              ; preds = %bb1
  %_12 = bitcast %OSUnalignedU32* %ptr to i32*
  call void @_ZN4core3ptr15write_unaligned17h3eef56860d75fb7cE(i32* %_12, i32 %4)
  br label %bb3
...
^0 = module: (path: "inputs-complex/url.h/individual-funcs_gpt-4o_2025-01-16_21-12-16/OSWriteSwapInt32.rs.bc", hash: (3233070798, 1857019372, 1941841771, 676177863, 537689834))
...
^9 = gv: (name: "os_write_swap_int32", summaries: (function: (module: ^0, flags: (linkage: external, visibility: default, notEligibleToImport: 0, live: 0, dsoLocal: 0, canAutoHide: 0), insts: 15, calls: ((callee: ^16))))) ; guid = 4471151277184323449
