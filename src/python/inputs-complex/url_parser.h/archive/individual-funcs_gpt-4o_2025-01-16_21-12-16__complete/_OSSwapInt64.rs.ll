; ModuleID = 'inputs-complex/url.h/individual-funcs_gpt-4o_2025-01-16_21-12-16/_OSSwapInt64.rs.bc'
...
start:
  ...
  store i64 1311768467294899695, i64* %original, align 8
  %_3 = load i64, i64* %original, align 8
  %0 = call i64 @osswap_int64(i64 %_3)
  store i64 %0, i64* %swapped, align 8
  br label %bb1

bb1:                                              ; preds = %start
  %1 = call { i8*, i64* } @_ZN4core3fmt10ArgumentV113new_upper_hex17hc750adc0982eb29cE(i64* align 8 %original)
...
^0 = module: (path: "inputs-complex/url.h/individual-funcs_gpt-4o_2025-01-16_21-12-16/_OSSwapInt64.rs.bc", hash: (182372184, 611350488, 709919089, 3684658863, 9256015))
