; ModuleID = 'inputs-complex/libcsv/individual-funcs_gpt-4o_2024-09-17_22-20-56__complete/csv_set_space_func.i.bc'
source_filename = "inputs-complex/libcsv/individual-funcs_gpt-4o_2024-09-17_22-20-56__complete/csv_set_space_func.i"
...
define dso_local void @csv_set_space_func(%struct.csv_parser* noundef %0, i32 (i8)* noundef %1) #0 {
...
7:                                                ; preds = %2
  ...
  %10 = getelementptr inbounds %struct.csv_parser, %struct.csv_parser* %9, i32 0, i32 10
