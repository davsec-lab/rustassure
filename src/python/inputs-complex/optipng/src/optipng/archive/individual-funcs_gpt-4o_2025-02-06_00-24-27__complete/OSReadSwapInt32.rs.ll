; ModuleID = 'inputs-complex/optipng/src/optipng/individual-funcs_gpt-4o_2025-02-06_00-24-27/OSReadSwapInt32.rs.bc'
...
bb1:                                              ; preds = %start
  %unaligned_ptr = bitcast i8* %4 to %OSUnalignedU32*
  %5 = call i32 @_ZN4core3ptr14read_unaligned17hf38ae59d3e063f37E(%OSUnalignedU32* %unaligned_ptr)
...
^0 = module: (path: "inputs-complex/optipng/src/optipng/individual-funcs_gpt-4o_2025-02-06_00-24-27/OSReadSwapInt32.rs.bc", hash: (1617495671, 2434044424, 1935981018, 3539200523, 4158157136))
