...
unsafe extern "C" fn opng_print_image_info(show_dim: c_uint, show_depth: c_uint, show_type: c_uint, show_interlaced: c_uint) {
    // Your implementation of opng_print_image_info function goes here
}
